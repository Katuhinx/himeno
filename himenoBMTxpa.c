...
#pragma xmp nodes p[2][2]// выделяем 4 узла 
#pragma xmp template t [mimax-1][mjmax-1][mkmax-1] //шаблон для матрицы 
#pragma xmp distribute t[block][block][block] onto p // распределяет массив t между набором узлов p
...
main(int argc, char *argv[])
{
 ...
 #pragma xmp align [i][j][k] with t(i,j,k) :: a, b, c, p, bnd, wrk1, wrk2;
